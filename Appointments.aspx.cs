    ...
    public partial class Appointments : System.Web.UI.Page
    {
        ...
        protected void lnkbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sqlcmd.CommandText = "Delete from [Appoinment_Form] where Patient_Id=@Patient_Id and Doctor_Id=@Doctor_Id and TreatDone='Pending'";
